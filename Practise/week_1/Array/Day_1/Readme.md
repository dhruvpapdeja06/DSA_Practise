...
In byte Addressable memory each byte of data has a unique address , allowing for individual byte access. The smallest 
unit of memory that can be access is 8bits.
